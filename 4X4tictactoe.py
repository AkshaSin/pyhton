...
class XorO(Board):
    ...
    def draw(self, square_number, mark):
        """Draws the board with current values"""
        ...
        for i in range(16):      # loop through the values in list board
            try:
...
# Create object b1 of the Play class – (Play class inherits from the Mark class which inherits from the Board class)
a = Play()
# Call the Draw function in the Board class
a.Draw()
# Start the game by calling the select_square function in the Play class
a.select_square()